...
public class LibroCalificaciones1 {
    ...
    private int[][] calificaciones; // a rreglo bidimensional de calificaciones de studiantes

    // el constructor con dos argumentos inicializa nombreDelCurso y el arreglo alificaciones
    public LibroCalificaciones1(String nombreDelCurso, int[][] calificaciones) {
    ...
    public void procesarCalificaciones() {
        ...
        // imprime gráfico de distribución de todas las calificaciones para todass pruebas
    ...
    // determina la calificación promedio para un conjunto específico de alificaciones
    ...
    public void imprimirGraficoBarras() {
        ...
        // para cada calificación en LibroCalificaciones, incrementa la frecuenciaapropiada
        for (int[] califEstudiantes : calificaciones) {
            for (int calificacion : califEstudiantes) {
    ...
    public void imprimirCalificaciones() {
        ...
        System.out.println("Promedio"); // encabezado de columna de promedio deestudiantes
        ...
        for (int estudiante = 0; estudiante < calificaciones.length; estudiante++) {
            ...
            for (int prueba : calificaciones[estudiante]) // imprime calificacionesde estudiante
            {
